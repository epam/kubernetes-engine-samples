...
gcloud builds submit \
  ...
  --substitutions=_DISK_IMAGE=$DISK_IMAGE,_CONTAINER_IMAGE=$CONTAINER_IMAGE,_BUCKET_NAME=$LOG_BUCKET_NAME,_REGION=$REGION,_CLUSTER_NAME=$CLUSTER_NAME,_PROJECT_ID=$PROJECT_ID
...
gcloud builds submit \
  ...
  --substitutions=_CLUSTER_NAME=$CLUSTER_NAME,_REGION=$REGION,_PROJECT_ID=$PROJECT_ID,_PROJECT_NUMBER=$PPROJECT_NUMBER,_BUCKET_NAME=$LOG_BUCKET_NAME,_DISK_IMAGE=$DISK_IMAGE