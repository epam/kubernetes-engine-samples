...
MACHINE_TYPE="r7a.4xlarge"
SYSBENCH_MACHINE_TYPE="m7a.8xlarge"
AMI_TYPE="BOTTLEROCKET_x86_64"

# Terraform execution for infrastructure
echo "--- Initializing Terraform ---"
terraform -chdir=terraform/aws/eks2 init

echo "--- Applying Terraform (Remaining Resources) ---"
terraform -chdir=terraform/aws/eks2 apply --auto-approve \
...
# Get cluster credentials for mysql-sysbench-eks-2 (AMD) cluster
echo "--- Updating kubeconfig ---"
aws eks update-kubeconfig --name mysql-sysbench-eks-2 --region us-east-1
