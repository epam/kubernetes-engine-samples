...
TEMP_KUBECONFIG_FILE="${KUBE_TEMP_DIR}/config-2"
cleanup() {
...
KUBERNETES_CLUSTER_PREFIX=mysql1
...
echo $ZONES > terraform/gke-standard-2/terraform.tfvars

# Create clusters
terraform -chdir=terraform/gke-standard-2 init
terraform -chdir=terraform/gke-standard-2 apply \
