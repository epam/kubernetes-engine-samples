...
# [START gke_streaming_mysql_vpc_multi_region_network]
module "gcp-network" {
...
# [END gke_streaming_mysql_vpc_multi_region_network]

# [START gke_streaming_mysql_cloudnat_simple_create]
module "cloud_router" {
...
# [END gke_streaming_mysql_cloudnat_simple_create]
